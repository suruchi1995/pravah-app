...
export const api = {
  ...
  submitChange: (token, body) => fetch(`${BASE}/change-requests`, { method:'POST', headers:{ Authorization:'Bearer '+token, 'Content-Type':'application/json' }, body: JSON.stringify(body) }).then(parseJson),
